...
<body>
	...
	<div class="container">
		<div class="row">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href='<c:url value="/voucher/general/ledger"/>'><button
					type="button" class="btn btn-primary btn-sx">Account
					Ledger</button></a> <a href='<c:url value="account/profit_loss"/>'><button
					type="button" class="btn btn-primary btn-sx">Profit / Loss
				</button></a> <a href='<c:url value="/voucher/general/trialbalance"/>'><button
					type="button" class="btn btn-primary btn-sx">Trial Balance</button></a>
			<div class="col-xs-12">
				<div class="col-xs-4"></div>
				<div class="col-xs-2">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
						href='<c:url value="/party/add"/>'><button type="button"
