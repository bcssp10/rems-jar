								...
								<c:forEach var="receipt" items="${receipts}">
									<tr>
										<td><a href="/receipt/${receipt.receiptId}"> <span
											...
											<a href="/receipt/delete/${receipt.receiptId}"> <span
												title="Delete" class="glyphicon glyphicon-trash"></span></a>&nbsp;
											<a href="/receipt/print/${receipt.receiptId}"> <span
												title="Print" class="glyphicon glyphicon-print"></span></a></td>
